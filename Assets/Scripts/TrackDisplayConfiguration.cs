...
public class TrackDisplayConfiguration : MonoBehaviour
{
    ...
    {
        return Application.dataPath + "/Data/" + "sub-" + SubInfo.subID + "/sub-" + FindObjectOfType<SubInfo>().subID + "_trialConfiguration.csv";
    }
